...
<?php
	...
	if(isset($_SESSION['id'])){
		exit('<a href="indexsanta.php">세션을 통해서 로그인 정보를 확인했습니다.</a></body></html>');
	}
	...
	if(mysqli_num_rows($result)==1){
		...
		echo "$email"."님의 로그인에 성공했습니다.<br/><br/><a href='indexsanta.php'>홈으로</a>";
	}
	else{
		echo "로그인에 실패했습니다.</br></br><a href='indexsanta.php'>홈으로</a>";
	}
